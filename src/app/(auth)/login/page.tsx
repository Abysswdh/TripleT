...
export default function LoginPage() {
  ...
  return (
    <div className="animate-fade-in mx-auto w-full max-w-4xl py-4 sm:py-8 px-2 sm:px-4">
      {/* 2-Column Split Card */}
      <div className="overflow-hidden rounded-3xl border border-slate-200/90 dark:border-border/60 bg-card shadow-2xl shadow-slate-200/60 dark:shadow-none flex flex-col lg:flex-row min-h-[560px]">
          ...
          <div className="relative z-10 space-y-4">
            <div className="space-y-1.5">
              <h2 className="text-2xl font-bold font-heading text-white leading-tight">
                Kembangkan Karir & Temukan Talenta Terbaik
              </h2>
              <p className="text-xs text-white/80 leading-relaxed font-light">
                Hubungkan kebutuhan proyek bisnismu dengan talenta muda terverifikasi di seluruh Indonesia.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 pt-3 border-t border-white/15 text-[11px] text-white/85">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-white/60">Terverifikasi</span>
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-white text-sm">Escrow</span>
                <span className="text-[10px] text-white/60">Garansi Aman</span>
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-white text-sm">Sertifikasi</span>
                <span className="text-[10px] text-white/60">Kuis Skill</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-10 flex flex-col justify-center bg-card">
          ...
          <div className="mb-6 text-left">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight font-heading">Selamat Datang</h1>
            <p className="mt-1 text-xs sm:text-sm text-muted-foreground">
              Masuk ke akunmu untuk melanjutkan ke dashboard
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label
                htmlFor="email"
                className="mb-1.5 block text-xs sm:text-sm font-medium"
              >
                Email
              </label>
              <input
