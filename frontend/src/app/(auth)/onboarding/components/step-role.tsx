    ...
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="pt-4">
        <button
          type="button"
          onClick={onNext}
          className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-primary text-sm font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary-600 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.99]"
        >
          <span>Lanjutkan</span>
