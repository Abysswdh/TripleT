                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-xs mt-0.5">
                            ...
                            <span className="text-muted-foreground">({app.reviewsCount} review sukses)</span>
                          </div>
                        </div>
                      </div>

                      <div className="text-left sm:text-right border-t sm:border-t-0 pt-2 sm:pt-0 border-border/40">
                        <span className="text-[10px] text-muted-foreground block">Tawaran Bid & Durasi</span>
                        <span className="text-base font-bold text-primary">{app.bidAmount}</span>
                        <span className="text-xs text-muted-foreground block font-medium">
                          Selesai dalam {app.deliveryDays} hari
                        </span>
                      </div>
                    </div>

                    {/* Pitch Cover Letter */}
                    <div className="rounded-xl bg-muted/40 p-3 text-xs text-foreground/90 leading-relaxed border border-border/40">
                      <strong className="block text-foreground font-semibold mb-1">Pesan Pendekatan & Solusi Teknis:</strong>
                      {app.pitch}
                    </div>
                    ...
                    <div className="pt-2 flex items-center justify-end gap-2 border-t border-border/40">
                      {isAccepted ? (
                        <div className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-500 px-4 py-2 text-xs font-semibold text-white">
                          <Check className="h-4 w-4" />
                          <span>Proposal Diterima • Escrow Didanai</span>
                        </div>
                      ) : (
                        <>
                          <button
